            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <a class="btn btn-sm btn-success" href={{route('issues.create') }}>Add Post</a>
                        </div>
                    </div>
                </div>
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <span class="custom-checkbox">
                                    <input type="checkbox" id="checkbox{{ $issue->id }}" name="options[]" value="{{ $issue->id }}">
                                    <label for="checkbox{{ $issue->id }}"></label>
                                </span>
                            </td>
                            <td>{{ $issue->id }}</td>
